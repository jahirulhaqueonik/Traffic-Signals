...
void frontscreen(void)
{
    ...
    glColor3f(1,0,0);
    drawstring(450.0,650.0,0.0,"Metropolitan University Bangladesh, Sylhet ");
    glColor3f(0.7,0,1);
    drawstring(330,600,0.0,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
    glColor3f(1,0.5,0);
    drawstring(530,550,0.0,"A MINI PROJECT ON");
    glColor3f(1,0,0);
    drawstring(360,500,0.0,"GRAPHICAL REPRESENTATION OF TRAFFIC SIGNALS");
    glColor3f(1,0.5,0);
    drawstring(580,400,0.0,"Created BY: ");
    glColor3f(1,1,1);
    drawstring(550,350,0.0,"Jahirul Haque Onik");
    glColor3f(1,1,1);
    drawstring(560,300,0.0,"ID: 181-115-020");
    glColor3f(1,1,1);
...
//function for control left right control of vehicles in road
void control()
{
